    ...
    <%@ include file="navbar.jsp" %>
      ...
      <div class="container con">
        <form autocomplete="off">
          ...
          <div class="row"
            style="margin-left:50%;margin-top:5%;  display: flex;justify-content: space-between;align-items: center;">
      ...
      <script type="text/javascript" charset="utf-8">
        ...
        $("#submit").on('click', function (event) {
          ...
          if (dateRegex.test(birthdate)) {
            // Input date is in valid format, parse it and convert to ISO string
            var parsedDate = new Date(birthdate);
            var isoDateString = parsedDate.toISOString();
            birthdate = isoDateString;
          } else {
            // Input date is not in valid format, handle the error (e.g., display a message, set birthdate to null, etc.)
            console.error('Invalid date format');
            birthdate = ''; // or set it to an appropriate default value based on your requirements
          }
